...
/**
 * REST controller for managing {@link jhipster.example.domain.Autor}.
 */
@RestController
@RequestMapping("/api")
public class AutorResource {
    ...
    private static final String ENTITY_NAME = "microserviceAutor";
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/autors/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<AutorDTO> partialUpdateAutor(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AutorDTO autorDTO
    ) throws URISyntaxException {
